...
// @icon         https://lh3.googleusercontent.com/j_wPyWvTJUCcKSGiSqOIjNjkNNJPxap_oc_sB8neApdmIYG6QfLHwDvPrSASKWypIIRHxbfNZV9wypl_Y8Nxt2obz8g=s60
// @namespace   knoa.jp
...
https://www.dr-lex.be/info-stuff/volumecontrols.html
  */
    ...
    const VIDEOVIEWS = [
        ...
        /^https?:\/\/[^/]+\/.*$/,
        /^https?:\/\/(?:www\.)?.+\.(?:com|org|net|io|co\.uk)\/.+$/,
    ];
    ...
    const site = {
        ...
        controlTargets: {
            ...
            muteButton: () => $('.ytp-left-controls, #video_progress_bar_bar') || $('button.ytp-mute-button') || $('video, #video_progress_bar_bar') || $('paper-icon-button.volume'),
    ...
    const core = {
        ...
        configs: {
            createButton: function(){ //------------------------------------------------------------contextmenu---------------------------------------------
    ...
    const html = {
        ...
        configPanel: () => `
      <div class="panel" id="${SCRIPTID}-configPanel" data-order="1" style="border-radius: 5px;">
        <h1 style="text-align: center; font-size: 17px;">${text('${SCRIPTNAME} preferences')}</h1>
